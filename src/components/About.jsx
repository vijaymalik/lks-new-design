...
function About() {
  ...
  return (
    <div className="w-full p-20 bg-[#cdea68] rounded-tl-3xl rounded-tr-3xl text-black">
      <h1 className="font-['neue'] text-[2vw] tracking-tight leading-[2.5vw]">
      ...
      <div className="flex gap-5 w-full border-t-[1px] pt-10 mt-20 border-[#a1b562]">
        <div className="w-1/2 ">
          <h1 className="text-5xl">Our Programs:</h1>
          <div
        ...
        {/* Image Section */}
        <div className="w-1/2 h-[70vh] overflow-hidden rounded-3xl bg-[#a8c63b] about-right">
          <img
