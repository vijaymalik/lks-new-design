...
const Footer = () => {
  return (
    ...
    >
      ...
      <div className="bg-green-900  text-white p-5 lg:p-20">
        <div className="lg:grid grid-cols-3 gap-20 ">
          ...
          <div>
            <h6 className="font-semibold text-2xl mt-10 lg:mt-0">Links</h6>
          ...
          <div>
            <h6 className="font-semibold text-2xl mt-10 lg:mt-0">Contact</h6>
